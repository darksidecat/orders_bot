...
def upgrade():
    ...
    sa.Column('name', sa.Enum('BLOCKED', 'USER', 'ADMINISTRATOR', name='levelname'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['access_level_id'], ['access_level.id'], onupdate='CASCADE', ondelete='CASCADE'),
    ...
    session.add_all((UpdatedLevels.BLOCKED.value, UpdatedLevels.USER.value, UpdatedLevels.ADMINISTRATOR.value))
    session.commit()
